...
//   Future<void> article(String topic) async {
//     String prompt =
//         "Give Links of top 3 articles related to the topic of $topic";
...
class _MessagesTabState extends State<MessagesTab> {
  ...
  int? highlightedIndex;
  late ScrollController _scrollController;
  Map<int, List<String>> _articleLinks = {};
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            TextButton(
                              onPressed: () {
                                fetchArticles(message.message, index);
                              },
                              child: const Text(
                                "Get top 5 articles",
                            ...
                            if (_articleLinks.containsKey(index))
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: _articleLinks[index]!.map((link) {
                                  return Padding(
